...
// import 'package:trycode/model/create_booking_court_param.dart';
...
//   String deviceId = "your_device_id"; // Replace with actual device ID retrieval logic
...
//       return;
//     }
//     int finalTotal = totalPrice - discount; // Apply discount here

//     _sendBookingDetails(phoneNumberController.text, usernameController.text, finalTotal, selectedCourtModels);
//   }

//   void _sendBookingDetails(String phone, String fullName, int finalTotalPrice, List<ListCourt> selectedCourtModels) async {
//     final Dio dio = Dio();
...
//         Get.snackbar('Error', 'Failed to submit booking details');
//       }
//     } catch (e) {
//       // Handle exceptions
//       Get.snackbar('Error', 'An error occurred while submitting booking details');
//     }
//   }
