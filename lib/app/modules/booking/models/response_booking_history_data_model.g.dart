...
_$ResponseBookingHistoryDataModelImpl
    _$$ResponseBookingHistoryDataModelImplFromJson(Map<String, dynamic> json) =>
        _$ResponseBookingHistoryDataModelImpl(
...
Map<String, dynamic> _$$ResponseBookingHistoryDataModelImplToJson(
        _$ResponseBookingHistoryDataModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
